  ...
  return (
    ...
    >
      <div className="flex justify-between items-center h-full pl-[50px] pr-[60px]">
        {/* logo */}
        <a href="/tatoo">
          <img className="w-[140px] ml-[-20px] sm:ml-0 xs:w-[188px] h-[90px]" src={logo} alt="" />
        </a>
        ...
        <div
          ...
          className="xl:hidden absolute right-[5%] bg-dark p-1 xs:p-2  rounded-md cursor-pointer"
        >
          <TiThMenuOutline className="text-2xl xs:text-3xl  text-white" />
        </div>
